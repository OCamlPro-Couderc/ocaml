...
include Identifiable.Make (struct
  ...
  let compare t1 t2 =
    ...
    | Runtime_and_external_libs, _ -> -1
    | Functions,
      (Compilation_unit _ | Startup
      | Shared_startup | Runtime_and_external_libs) -> 1
  ...
  let print ppf t =
    ...
    | Functions ->
      Format.pp_print_string ppf "Functions"
