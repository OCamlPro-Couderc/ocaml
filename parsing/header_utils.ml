...
let import_structure hierarchy =
  let imports, opened = List.split @@ List.map mk_structure hierarchy in
...
let import_signature hierarchy =
  let imports, opened = List.split @@ List.map mk_signature hierarchy in
