...
val applied_unit: Env.t -> (Ident.t * Ident.t) list -> ((Ident.t * Digest.t) * Ident.t) list
  -> Cmi_format.cmi_infos -> namespace_info
  -> string -> Typedtree.module_coercion list * Env.application option
