...
val save_signature:
  alerts:alerts -> need_code:bool
  -> signature -> Compilation_unit.Name.t -> filepath
  -> Cmi_format.cmi_infos
        (* Arguments: signature, module name, file name. *)
val save_signature_with_imports:
  alerts:alerts -> need_code:bool
  -> signature -> Compilation_unit.Name.t -> filepath -> Compilation_unit.crcs
  -> Cmi_format.cmi_infos
        (* Arguments: signature, module name, file name,
...
val imports_from_recursive_pack: unit -> Compilation_unit.t list
...
val recursive_pack_component_id: Compilation_unit.t -> Ident.t
